"""
Retry/reconnect behaviour tests for StatusInvestScraper.
...
# ---------------------------------------------------------------------------
# Stub pika at the module level so the real import in main.py does not fail.
# Individual tests will replace pika.BlockingConnection via patch.
# ---------------------------------------------------------------------------
...
import pika as _pika  # noqa: E402  (imported after stub registration)
import main as _main_module  # noqa: E402


def _make_scraper_no_connect() -> "_main_module.StatusInvestScraper":
    """Return a StatusInvestScraper without triggering a RabbitMQ connection."""
    return _main_module.StatusInvestScraper(connect_rabbitmq=False)
...
class RabbitMQRetryTests(unittest.TestCase):
    """Tests for the retry/reconnect logic in StatusInvestScraper.connect_rabbitmq()."""

    def setUp(self):
        self.scraper = _make_scraper_no_connect()
    ...
    def test_succeeds_on_first_attempt(self):
        ...
        self.assertIs(self.scraper.connection, mock_conn)
        self.assertIs(self.scraper.channel, mock_channel)
    ...
    def test_channel_is_set_on_successful_connect(self):
        ...
        self.assertIsNotNone(self.scraper.channel)
